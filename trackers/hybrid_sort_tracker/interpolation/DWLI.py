...
def interpolate_bbox_refined(left_bbox, right_bbox, left_frame, right_frame, curr_frame, 
                           gap_size=None):
    """
    精炼的动态权重插值
    保持原始算法的核心，仅做微小改进
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gap_threshold', type=int, default=None, 
                        help='自定义gap阈值，用于DanceTrack优化')
