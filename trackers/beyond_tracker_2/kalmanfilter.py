...
class KalmanFilterNew(object):
    ...
    **Example**
    ...
    def __init__(self, dim_x, dim_z, dim_u=0, alpha=10):
        if dim_x < 1:
    ...
    def update(self, z, confidence=1.0,R=None, H=None, r_thresh=20):
        """
        ...
        # dancetrack  confidence < 0.8 and r_thresh = 50
        # MOT17 confidence > 0.8 and r_thresh = 20
        # if confidence > 0.8: 
        #     R = [(1 - confidence) * r_thresh * x for x in R]
